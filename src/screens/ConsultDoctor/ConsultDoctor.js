...
import { StyleSheet, FlatList, Text, TouchableOpacity, Button, Dimensions, View } from 'react-native'
...
class ConsultDoctorScreen extends React.Component {
    ...
    _renderItem=({item, index}) => {
      return (
        ...
        <View style= {{height: 180,marginBottom:50,borderColor:'green',borderRadius:5}}>
